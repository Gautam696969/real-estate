        ...
        <section className="py-20 pt-32 bg-dark-100 relative overflow-hidden">
          ...
          <div className="max-w-[1200px] mx-auto px-5">
            <div className="text-center mb-14">
              ...
              <h2 className="text-[2.5rem] font-bold text-white capitalize">Sell Your Property</h2>
              <p className="text-white/40 text-base mt-3 max-w-2xl mx-auto">List your property with us and reach thousands of potential buyers. Get the best value for your property.</p>
            </div>
                ...
                <div key={item} className="bg-dark-200/80 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/5 transition-all duration-500 hover:border-gold-600/30 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:-translate-y-1 group">
                  <div className="relative overflow-hidden">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1.5 bg-purple-600/90 text-white text-xs font-semibold rounded-lg backdrop-blur-sm">For Sale</span>
                    </div>
                  </div>
                  <div className="p-6">
                    <h3 className="text-lg font-bold text-white mb-2">Premium Property {item}</h3>
                    <p className="text-white/50 text-sm mb-4">Excellent investment opportunity in a prime location with high appreciation potential.</p>
                    <div className="flex items-center justify-between">
                      <div className="text-xl font-bold text-gold-600">$550,000</div>
                      <a href="#" className="px-4 py-2 bg-gold-600 text-dark-500 text-sm font-semibold rounded-lg">Sell Now</a>
                    </div>
                  </div>
                </div>
              ))}
