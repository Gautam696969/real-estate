    ...
    <div className="app-wrapper">
      ...
      <main>
        <section className="breadcrumb-outer py-20 pt-32 relative min-h-[500px]">
          <img src="https://ravmoyaanrealty.com/images/bg/home-171.jpg" alt="Sell Property Background" className="absolute inset-0 w-full h-full object-cover" />
              ...
              <div className="detail-title-inner">
                <div className="row grid grid-cols-1 lg:grid-cols-12 gap-6">
                  <div className="col-span-12 lg:col-span-7">
                    ...
                    <h2 className="text-[2.5rem] font-bold text-white capitalize"><span>Sell Property</span></h2>
          ...
          <div className="max-w-[1200px] mx-auto px-5">
            <div className="row grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="col-span-12 lg:col-span-6 who-1">
                <div>
                  <h2 className="text-left text-3xl font-bold text-white mb-4">Sell <span className="text-gold-600">Propery</span></h2>
                </div>
                <div className="pftext space-y-4">
                  <p className="text-white/60 leading-relaxed">Your property deserves more than a "list and wait" approach. Rav-Mo-Yaan Realty Associates uses data-driven pricing, high-visibility marketing, and proactive negotiation to attract qualified buyers and maximize your sale price. From prep to closing, we provide hands-on support, fast communication, and a smooth selling experience.</p>
                  <p className="text-white/60 leading-relaxed">If you tell me your main market (Illinois vs India) and whether you specialize in residential, multi-family, or investor sales, I can tailor this to match your exact niche.</p>
                </div>
