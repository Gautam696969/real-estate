              ...
              <div className="detail-title-inner">
                <div className="row grid grid-cols-1 lg:grid-cols-12 gap-6">
                  <div className="col-span-12 lg:col-span-7">
                    ...
                    <h2 className="text-[2.5rem] font-bold text-white capitalize"><span>Rent Property</span></h2>
          ...
          <div className="max-w-[1200px] mx-auto px-5">
            <div className="row grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              <div className="col-span-12 lg:col-span-6 who-1">
                <div>
                  <h2 className="text-left text-3xl font-bold text-white mb-4">Rent <span className="text-gold-600">Propery</span></h2>
                </div>
                <div className="pftext space-y-4">
                  <p className="text-white/60 leading-relaxed">Renting should be simple—whether you're searching for a place to live or looking for the right tenant for your property. Rav-Mo-Yaan Realty Associates helps renters identify the best options based on budget, location, and lifestyle, and guides them through applications, documentation, and lease signing.</p>
                  <p className="text-white/60 leading-relaxed">For property owners, we assist with rental pricing, marketing, showings, tenant screening support, and lease coordination to help you secure reliable tenants and minimize vacancy time. Our goal is fast communication, clear expectations, and a smooth move-in process for everyone.</p>
                </div>
