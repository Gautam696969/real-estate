            ...
            >
               {variant === 'grid' ? (
                 <a href="#" className="block relative overflow-hidden group rounded-xl bg-dark-300 border border-white/5 hover:border-gold-600/30 transition-all duration-500">
                   <div className="w-full h-100 bg-cover bg-center transition-all duration-700 group-hover:scale-110" style={{ backgroundImage: `url(${prop.image})` }}></div>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <div className="flex items-center gap-4 text-sm text-white/80 mb-4">
                      <span className="flex items-center gap-1.5"><i className="fa fa-bed text-gold-600"></i> {prop.beds}</span>
                      <span className="flex items-center gap-1.5"><i className="fa fa-bath text-gold-600"></i> {prop.baths}</span>
                      <span className="flex items-center gap-1.5"><i className="fa fa-arrows-alt text-gold-600"></i> {prop.sqft} sqft</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="text-xl font-bold text-gold-600">{prop.price}</div>
                      <div className="px-4 py-2 bg-gold-600 text-dark-500 text-sm font-semibold rounded-lg opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                        View Details
                      </div>
                    </div>
                  </div>
                ...
                <div className="project-single w-full">
                  <div className="relative overflow-hidden rounded-xl bg-dark-200 border border-white/5 hover:border-gold-600/30 transition-all duration-500 group">
                     <img src={prop.image} alt={prop.title} className="w-full h-[400px] object-cover transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/80 to-transparent z-10">
                      <h3 className="text-white text-lg font-bold mb-1">{prop.location}</h3>
